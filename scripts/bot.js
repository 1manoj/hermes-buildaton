...
import { parseBotCommand,updateTopicsFromCommand,botHelp } from "../src/bot-commands.js";
...
async function deliver(user,chatId,count=4){const briefing=buildFirstBriefing(user,await latestBulletin(),count);return sendTelegramBriefing(config.telegramToken,chatId,briefing);}
