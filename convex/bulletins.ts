...
const story=v.object({title:v.string(),summary:v.string(),shortSummary:v.string(),rank:v.number(),url:v.string(),source:v.string(),category:v.string(),article:v.optional(v.string()),audioScript:v.optional(v.string()),audioUrl:v.optional(v.union(v.string(),v.null()))});
