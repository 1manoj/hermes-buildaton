...
export default defineSchema({
  ...
  bulletins: defineTable({headline:v.string(),script:v.string(),topics:v.array(v.string()),audioUrl:v.optional(v.string()),sourceUrls:v.array(v.string()),publishedAt:v.number()}),
